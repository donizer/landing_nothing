...
export const Header = () => {
  return (
    <>
      <div className="bg-lady-with-phone col-span-full flex h-[568px] w-full flex-col justify-between bg-cover bg-center px-[20px] md:h-[993px] md:px-[72px] xl:h-[720px] xl:px-[120px]">
        <HeaderMenuBar phone />
